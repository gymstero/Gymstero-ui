...
const Social = () => {
  ...
  const searchUser = async () => {
    ...
    fetch(`http://10.0.2.2:8080/api/user/${userInfo.uid}?username=${input}`, {
      method: "Get",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
                ...
                <Pressable>
                  <HStack mt={2}>
                    ...
                    <Container ml="auto" mr={1}>
                      <Text my="auto">{item.username}</Text>
                    </Container>
                  </HStack>
                </Pressable>
              )}
                ...
                <Pressable>
                  <HStack mt={2}>
                    ...
                    <Container w="45%" ml={4} my="auto">
                      <Text fontSize={20}>{item.username}</Text>
                    </Container>
                    ...
                    <HStack alignSelf="center">
                      <Button
                        ...
                        textAlign="right"
                        alignSelf="center"
                        onPress={() => followAction(following, item.id)}
                      >
